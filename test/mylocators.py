...
sauces_header = "//h2[text()='Соусы']" #Объект вкладка для Соусы
fillings_header = "//h2[text()='Начинки']" #Объект вкладка для Начинки
...
personal_account_profile = "//a[@href='/account/profile']" #Страница Личный Кабинет